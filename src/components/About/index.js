...
function About() {
  return (
    <div className="About">
      ...
      <br/><br/>
      Former colleagues would describe me as their go-to for problem solving, superuser of our electronic medical record, being known for my attention to detail, integrity, adaptability and leadership. I am an experienced communicator as a teacher, presenter, and patient-care provider. My thirst to always be learning, passion for excellence, comfort in a fast-paced environment, internal drive and commitment to deliver results make me the ideal candidate for a quality-focused Junior Software Developer position. I am looking for a challenging role within a company that is spirited, driven to succeed, and offers opportunities for growth.
      <br/><br/>
      I am a BOC Certified Athletic Trainer (AT) and am licensed to practice in WA by the DOH. I graduated with my Bachelor of Science in Athletic Training from Chapman University. In February 2022 I ended an employment of over 6 years at Seattle Children's Hospital. During that time I was the head Athletic Trainer at The Bush School, lead for our CPR program, Cystic Fibrosis Exercise Specialist, and one of the first Athletic Trainers in a brand new role that brought ATs into the Orthopedics and Sports Medicine Clinic.
      <br/><br/>
      My hobbies include innovation, volunteer coaching for Girls on The Run Puget Sound, country music, sports medicine, hiking, soccer, Peloton, reading, spending time with friends/family, and interior design. I am a member of ATPPS, NATA and the Gamma Phi Beta sorority.</p>
    </div>
  );
}
